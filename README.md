...
Acredito que linguagens e frameworks são apenas ferramentas na maleta de um engenheiro, e o segredo é sempre puxar a ferramenta certa para o trabalho certo. Apesar do meu amor declarado pelo **Java** (preferindo sempre estruturar código e documentação técnica em inglês para manter o mais alto padrão), amo construir microsserviços em **Go** *(APENAS SE NECESSÁRIO KKKK)*, subir APIs em Python e, principalmente, debugar, sendo este último o meu esporte preferido.
